  ...
  */
  ...
  const handleCardDelete = async() => {
    ...
    if (confirmDelete) {
      ...
      const response = await fetch('${process.env.BACKEND_URI}/api/todo/'+cardId, {
      method: 'DELETE'
    })
  ...
  const handleDragEnd = async (cardId, sourceLaneId, targetLaneId) => {
    ...
    switch (targetLaneId) {
      case "lane1":
        const response = await fetch('${process.env.BACKEND_URI}/api/todo/todo/' + cardId, {
            method: 'PATCH',
            //body: JSON.stringify(todo),
            headers: {
                'Content-Type': 'application/json'
        ...
        console.log(json)
        //create History
        const res = await fetch('${process.env.BACKEND_URI}/api/hist/',{
            method: 'POST',
        ...
        const res2 = await fetch('${process.env.BACKEND_URI}/api/user/history/token/',{
            method: 'POST',
            body: JSON.stringify({"token": sub,"hid":hid}),
            headers: {
              'Content-Type': 'application/json'
      ...
      case "lane2":
        const response2 = await fetch('${process.env.BACKEND_URI}/api/todo/doing/' + cardId, {
            method: 'PATCH',
            //body: JSON.stringify(todo),
            headers: {
                'Content-Type': 'application/json'
        ...
        console.log(json2)
        //create History
        const res3 = await fetch('${process.env.BACKEND_URI}/api/hist/',{
            method: 'POST',
        ...
        //give history to User
        const res4 = await fetch('${process.env.BACKEND_URI}/api/user/history/token/',{
            method: 'POST',
      ...
      case "lane3":
        const response3 = await fetch('${process.env.BACKEND_URI}/api/todo/finish/'+ cardId, {
            method: 'PATCH',
            //body: JSON.stringify(todo),
            headers: {
                'Content-Type': 'application/json'
        ...
        console.log(json3)
        //create History
        const res5 = await fetch('${process.env.BACKEND_URI}/api/hist/',{
            method: 'POST',
        ...
        //give history to User
        const res6 = await fetch('${process.env.BACKEND_URI}/api/user/history/token/',{
            method: 'POST',
  ...
  useEffect(() => {
    ...
    const fetchT = async () => {
      ...
      const userJson = await userRes.json()
      const uid = userJson._id
      const response = await fetch('${process.env.BACKEND_URI}/api/user/todo/todo/'+uid)
      const json = await response.json()
      ...
      if(response.ok && !cleanUp && json !== null) { // Is it necessary to change the while loop into a for each loop?
        ...
        while(i < json.length) {
          const res = await fetch('${process.env.BACKEND_URI}/api/plan/'+json[i].ofPlan)
  ...
  useEffect(() => {
    ...
    const fetchD = async () => {
      ...
      const userJson = await userRes.json()
      const uid = userJson._id
      const response = await fetch('${process.env.BACKEND_URI}/api/user/todo/doing/'+uid)
      const json = await response.json()
      console.log("json: ",json.length)
  ...
  useEffect(() => {
    ...
    const fetchF = async () => {
      ...
      const userJson = await userRes.json()
      const uid = userJson._id
      const response = await fetch('${process.env.BACKEND_URI}/api/user/todo/finished/'+uid)
      const json = await response.json()
